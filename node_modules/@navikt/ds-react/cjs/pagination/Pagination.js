        ...
        react_1.default.createElement("ul", { className: "navds-pagination__list" },
            react_1.default.createElement("li", null,
                react_1.default.createElement(Item, { className: (0, clsx_1.default)("navds-pagination__prev-next", {
                        ...
                        ? { "aria-hidden": true }
                        : { title: "Forrige" }))) }, prevNextTexts && (react_1.default.createElement(__1.BodyShort, { size: size === "xsmall" ? "small" : size, className: "navds-pagination__prev-text" }, "Forrige")))),
            ...
            react_1.default.createElement("li", null,
                react_1.default.createElement(Item, { className: (0, clsx_1.default)("navds-pagination__prev-next", {
                        ...
                        ? { "aria-hidden": true }
                        : { title: "Neste" }))), iconPosition: "right" }, prevNextTexts && (react_1.default.createElement(__1.BodyShort, { size: size === "xsmall" ? "small" : size, className: "navds-pagination__next-text" }, "Neste")))))));
});

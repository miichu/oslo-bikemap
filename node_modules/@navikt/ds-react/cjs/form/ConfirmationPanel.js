...
exports.ConfirmationPanel = (0, react_1.forwardRef)((_a, ref) => {
    ...
    return (react_1.default.createElement("div", { className: (0, clsx_1.default)("navds-confirmation-panel", "navds-form-field", className, {
        ...
        react_1.default.createElement("div", { className: "navds-confirmation-panel__inner" },
            children && (react_1.default.createElement(__1.BodyLong, { size: props.size, className: "navds-confirmation-panel__content", id: `confirmation-panel-${id}`, as: "div" }, children)),
            react_1.default.createElement(__1.Checkbox, Object.assign({ ref: ref }, props, inputProps, { "aria-describedby": (0, clsx_1.default)(inputProps["aria-describedby"], children && `confirmation-panel-${id}`), error: hasError, size: size }), label)),
        react_1.default.createElement("div", { className: "navds-form-field__error", id: errorId, role: "alert" }, showErrorMsg && react_1.default.createElement(__1.ErrorMessage, { size: size }, props.error))));
});

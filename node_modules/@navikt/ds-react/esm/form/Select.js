...
export const Select = forwardRef((props, ref) => {
    ...
    return (React.createElement("div", { className: cl(className, "navds-form-field", `navds-form-field--${size}`, {
        ...
        React.createElement("div", { className: "navds-select__container", style: style },
            React.createElement("select", Object.assign({}, omit(rest, ["error", "errorId", "size", "readOnly"]), inputProps, readOnlyEventHandlers, { ref: ref, className: cl("navds-select__input", "navds-body-short", `navds-body--${size !== null && size !== void 0 ? size : "medium"}`), size: htmlSize }), children),

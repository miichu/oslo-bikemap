...
export const MonthCaption = () => {
    ...
    return (React.createElement("div", { className: "navds-date__caption" },
        React.createElement(Button, { className: "navds-date__caption-button", disabled: hasPrevYear(), onClick: () => handleButtonClick(-1), "aria-label": labelPrevYear(locale === null || locale === void 0 ? void 0 : locale.code), icon: React.createElement(ArrowLeftIcon, { "aria-hidden": true }), variant: "tertiary", type: "button" }),
        ...
        React.createElement(Button, { className: "navds-date__caption-button", disabled: hasNextYear(), onClick: () => handleButtonClick(1), "aria-label": labelNextYear(locale === null || locale === void 0 ? void 0 : locale.code), icon: React.createElement(ArrowRightIcon, { "aria-hidden": true }), variant: "tertiary", type: "button" })));
};
